...
"""EMNIST Spatial Recall 2D (Color Conditioning) - Mamba + Patchify XS.
...
# Patchification parameters (p=4 is best for Mamba based on color_selection results)
PATCH_SIZE = 4
STRIDE = 4
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST color conditioning with Mamba + Patchify XS."""
