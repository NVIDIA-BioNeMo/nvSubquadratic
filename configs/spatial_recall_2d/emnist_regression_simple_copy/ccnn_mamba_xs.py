...
"""EMNIST Spatial Recall 2D - Mamba XS (Extra-Small).

Model Size: XS (Extra-Small)
- Hidden dim: 96 (param-matched to Hyena/Attention XS)
- Params: ~776K (bidirectional, expand=2, headdim=32)
- Heads: 6
...
# Network parameters - XS size (param-matched to Hyena/Attention)
INPUT_CHANNELS = 1  # Grayscale
OUTPUT_CHANNELS = 1  # Grayscale target
HIDDEN_DIM = 96  # Smaller than Hyena/Attn (160) due to Mamba efficiency
HEADDIM = 32  # inner_dim=192, heads=6
EXPAND = 2
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST spatial recall with Mamba XS."""
