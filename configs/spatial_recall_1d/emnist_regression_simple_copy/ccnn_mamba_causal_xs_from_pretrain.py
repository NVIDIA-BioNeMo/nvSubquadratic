...
Usage:
    ...
    --start_from_checkpoint.run_path=dromeroguzma/nvsubq_paper/abc123xyz
"""

from configs.spatial_recall_1d.emnist_regression_simple_copy.ccnn_mamba_causal_xs import (
...
def get_config():
    ...
    config.start_from_checkpoint = StartFromCheckpointConfig(
        load=True,
        run_path="implicit-long-convs/nvsubq_paper/q1wklbij",
