...
(ccnn_attn_causal_xs_pretrain.py) and fine-tunes on the spatial recall task.
...
from configs.spatial_recall_1d.emnist_regression_simple_copy.ccnn_attn_causal_xs import (
...
def get_config():
    """Get config for fine-tuning Attention XS from pretrained checkpoint."""
