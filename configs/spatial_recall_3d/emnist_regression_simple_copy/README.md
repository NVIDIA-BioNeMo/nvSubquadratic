...
python -m nvsubq_paper.train \
    --config configs/spatial_recall_3d/emnist_regression_simple_copy/ccnn_hyena_xs.py
```
...
sbatch run_cxis.sh configs/.../ccnn_hyena_xs.py \
