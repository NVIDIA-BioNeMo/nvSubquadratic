#!/bin/bash
#SBATCH --account=healthcareeng_bionemo    # account (adjust to your account)
...
#SBATCH --exclusive
#SBATCH --job-name=healthcareeng_bionemo-nvsubq.imagenet64-diffusion        # IMPORTANT: Keep same name for singleton to work
...
CONFIG_OVERRIDES="${CONFIG_OVERRIDES} wandb.entity=dafidofff"

# Container configuration
IMAGE_NAME=<path to the sqsh file>

# Host paths
WORKDIR=${PWD}
RUNS_DIR="${WORKDIR}/runs"
DATA_DIR="/lustre/fsw/healthcareeng_bionemo/amoradzadeh/hyena"
