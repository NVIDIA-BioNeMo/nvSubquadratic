...
| `patch_merging.py`                 | \[x\]  | Shared 2×2 merge; token/register-row and padded spatial-grid APIs                        |
...
| `vit5_hierarchical.py`                | \[x\]  | Four-stage spatial-grid hierarchy, padded merges and per-stage stochastic depth                     |
| `vit5_hierarchical_classification.py` | \[x\]  | Configurable token hierarchy with register-row FiLM and GAP                                         |
...
| `datamodules/cifar10.py`                       | \[x\]  | Torchvision CIFAR-10, channels-last collate and Mixup/CutMix                                               |
| `datamodules/cifar10_hf.py`                    | \[x\]  | Hugging Face CIFAR-10 with configurable augmentation                                                       |
