...
"""1D Color Conditioning — Hyena XS with Patchify (v2, causal).
...
Causal by default; pass
``net.block_cfg.sequence_mixer_cfg.mixer_cfg.global_conv_cfg.is_causal=False``
