...
"""Shared config for 2D color conditioning — spatial recall v2.

Task: 4 EMNIST digits with coloured bounding boxes on a 64x64 RGB canvas.
The model must output the target digit coloured to match its frame.
...
def base_experiment_config(
    ...
    config.wandb = WandbConfig(
        ...
        job_group="spatial_recall_v2_2d_color_conditioning",
    )
