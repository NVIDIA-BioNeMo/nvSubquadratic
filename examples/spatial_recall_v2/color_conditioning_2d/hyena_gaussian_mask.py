...
"""2D Color Conditioning — Hyena XS with Gaussian mask (v2).
...
from examples.spatial_recall_v2.color_conditioning_2d.hyena import HIDDEN_DIM
from examples.spatial_recall_v2.color_conditioning_2d.hyena import get_config as _get_hyena_config
