...
"""2D Color Conditioning — Hyena XS with Gaussian mask, no-gate ablation.

Same as hyena_gaussian_mask.py but both gates use Identity (plain element-wise products).
"""
...
def get_config() -> ExperimentConfig:
    ...
    config.net.block_cfg.sequence_mixer_cfg = mixer_defaults.get_hyena_mixer_cfg(
        ...
        gate_nonlinear_2_cfg=LazyConfig(torch.nn.Identity)(),
    )
