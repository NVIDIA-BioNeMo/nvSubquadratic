...
"""2D Color Conditioning — Mamba XS with Patchify (v2, bidirectional).

Hidden dim: 160, 4 blocks, headdim=32, expand=2, bidirectional.
~1.90M params. Patch_size=8 (64×64 → 8×8 = 64 tokens).
4 items on canvas with coloured frames, output digit in matching colour.

Patchification via Conv2d with kernel_size=stride=patch_size.
