...
grayscale canvas.  The model must regress the digit from the readout corner.
...
# EMNIST is small enough to stay fully in RAM; workers only run the
# canvas-composition transform, so a moderate count suffices.
NUM_WORKERS = 4
...
def base_experiment_config(
    ...
    config.wandb = WandbConfig(
        ...
        job_group="spatial_recall_v2_2d_simple_copy",
    )
