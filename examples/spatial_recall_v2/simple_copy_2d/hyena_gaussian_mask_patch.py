...
"""2D Simple Copy — Hyena XS with Patchify + Gaussian mask (v2).
...
from examples.spatial_recall_v2.simple_copy_2d.hyena_patch import HIDDEN_DIM
from examples.spatial_recall_v2.simple_copy_2d.hyena_patch import get_config as _get_hyena_patch_config
