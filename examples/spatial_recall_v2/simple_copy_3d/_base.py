...
The model must recall the target at the back-bottom-right corner.

v2 modernisations (relative to v1):
- RMSNorm instead of LayerNorm (v1 already used bf16-mixed)
...
def base_experiment_config(
    ...
    config.wandb = WandbConfig(
        ...
        job_group="spatial_recall_v2_3d_simple_copy",
    )
