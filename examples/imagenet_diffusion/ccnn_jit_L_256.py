...
"""CCNN diffusion on ImageNet 256x256, JiT-L matched (1024 hidden, 24 blocks, patch 16)."""
...
# Dataset ----------------------------------------------------------------------
BATCH_SIZE = 32  # Per GPU — reduced for large model at 256px
NUM_WORKERS = min(12, os.cpu_count() - 2 or 4)
FINAL_IMAGE_SIZE = 256
PATCH_SIZE = 16  # 256 / 16 = 16x16 tokens
...
# Network params (CCNN matching JiT-L)
INPUT_CHANNELS = 3
OUTPUT_CHANNELS = 3
DATA_DIM = 2
...
WEIGHT_DECAY = 0.0
GRAD_CLIP = 1.0
ACCUMULATE_GRAD_STEPS = 8  # 32 * 4 GPUs * 8 = 1024 effective batch size
...
def get_config() -> DiffusionExperimentConfig:
    ...
    # CCNN Model — JiT-L matched at 256x256
                ...
                mixer_cfg=LazyConfig(Hyena)(
                    global_conv_cfg=LazyConfig(CKConvND)(
                        ...
                        kernel_cfg=LazyConfig(SIRENKernelND)(
                            ...
                            mlp_hidden_dim=64,  # Larger kernel MLP for L-size
                            num_layers=3,
                            embedding_dim=64,
                            omega_0=KERNEL_OMEGA_0,
                            hidden_omega_0=KERNEL_HIDDEN_OMEGA_0,
                            L_cache=FINAL_IMAGE_SIZE // PATCH_SIZE,  # 16
                            use_bias=True,
                        ),
    ...
    config.wandb = WandbConfig(
        job_group="imagenet_diffusion_ccnn_L_256",
        entity=WANDB_ENTITY,
        tags=["ccnn", "diffusion", "imagenet256", "jit-L-matched"],
    )
