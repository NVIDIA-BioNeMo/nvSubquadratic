...
def get_config():
    """Base Model, 64x64, Linear Beta Schedule.
    ...
    # Linear schedule usually doesn't use the cosine_interpolated params,
    # but good to reset them or ensure they don't break anything.
    # The wrapper handles it based on 'beta_schedule' string.
    ...
    # Tags
    config.wandb.job_group = "sweep_base_64_linear_sched"
