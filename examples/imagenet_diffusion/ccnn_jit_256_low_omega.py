...
"""CCNN diffusion on ImageNet 256x256, JiT-B matched, low omega_0 (3.0).

Identical to ccnn_jit_256 except omega_0 is reduced from 10.0 to 3.0 to
...
def get_config() -> DiffusionExperimentConfig:
    ...
    config.wandb = WandbConfig(
        job_group="imagenet_diffusion_ccnn_256_low_omega",
        entity=WANDB_ENTITY,
        tags=["ccnn", "diffusion", "imagenet256", "jit-B-matched", "low-omega"],
    )
