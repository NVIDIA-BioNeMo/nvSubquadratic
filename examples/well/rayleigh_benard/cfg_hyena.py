"""Config file for WELL benchmark: rayleigh_benard dataset with Hyena.

Rayleigh-Benard convection: 512x128 spatial resolution, non-periodic (wall) BCs
in the vertical direction -> zero FFT padding.
"""
...
DROPOUT_RATE = 0.0
GRID_TYPE = "single"
FFT_PADDING = "zero"  # Non-periodic (wall) boundary conditions in vertical
OMEGA_0 = 100.0
PATCH_SIZE = 4
# L_cache should match the smaller patched dimension: min(512, 128) / PATCH_SIZE = 32
...
def get_config() -> ExperimentConfig:
    ...
    config.wandb = WandbConfig(
        ...
        entity="maxxxzdn",
        job_group="rayleigh_benard_hyena",
    )
