"""Shared config for MHD_64 experiments (v2).

Dataset: MHD_64
    - 3D, 64³, 7 dynamic fields, 0 constant fields
    - Dynamic fields: density, magnetic_field_{x,y,z}, velocity_{x,y,z}
    - ~77 train trajectories × 100 timesteps (only 40 total trajs — noisy)
...
BOUNDARY_CONDITIONS = {"x": "PERIODIC", "y": "PERIODIC", "z": "PERIODIC"}

N_FIELDS = 7  # density, magnetic_field_{x,y,z}, velocity_{x,y,z}
N_CONSTANT_FIELDS = 0
IN_CHANNELS = N_STEPS_INPUT * N_FIELDS + N_CONSTANT_FIELDS  # 28
OUT_CHANNELS = N_FIELDS  # 7

# 77 train trajectories × 96 windows = 7,392 samples
SAMPLES_PER_EPOCH = 7_392

# ─── Training constants (shared across models) ───────────────────────────────
TRAINING_ITERATIONS = 110_000
WARMUP_ITERATIONS_PERCENTAGE = 0.05

BATCH_SIZE = 64  # configs/data/MHD_64.yaml
NUM_WORKERS = 12
GRAD_CLIP = 1.0
