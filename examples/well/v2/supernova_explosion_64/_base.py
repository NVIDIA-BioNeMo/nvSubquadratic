"""Shared config for supernova_explosion_64 experiments (v2).
...
Dataset: supernova_explosion_64
    ...
    - 592 train trajectories × 59 timesteps
    - Close race with U-net baseline (0.3063 vs CNextU-net 0.3181)
...
# 592 train trajectories × 55 windows = 32,560 samples
SAMPLES_PER_EPOCH = 32_560
