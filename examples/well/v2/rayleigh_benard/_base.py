...
"""Shared config for rayleigh_benard experiments (v2).

Dataset: rayleigh_benard
    - 2D, 512×128, 4 dynamic fields, 0 constant fields
    - Dynamic fields: buoyancy, pressure, velocity_{x,y}
    - ~1400 train trajectories × 200 timesteps
    - All models perform poorly; TFNO wins (0.6566)
...
N_FIELDS = 4  # buoyancy, pressure, velocity_{x,y}
N_CONSTANT_FIELDS = 0
IN_CHANNELS = N_STEPS_INPUT * N_FIELDS + N_CONSTANT_FIELDS  # 16
OUT_CHANNELS = N_FIELDS  # 4

# 1400 train trajectories × 196 windows = 274,400 samples
SAMPLES_PER_EPOCH = 274_400

# ─── Training constants (shared across models) ───────────────────────────────
TRAINING_ITERATIONS = 110_000
WARMUP_ITERATIONS_PERCENTAGE = 0.05

BATCH_SIZE = 64  # configs/data/rayleigh_benard.yaml
NUM_WORKERS = 12
GRAD_CLIP = 1.0
