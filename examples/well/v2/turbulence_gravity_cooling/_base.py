"""Shared config for turbulence_gravity_cooling experiments (v2).

Dataset: turbulence_gravity_cooling
    - 3D, 64³, 6 dynamic fields, 0 constant fields
    - Dynamic fields: density, pressure, temperature, velocity_{x,y,z}
    - ~2160 train trajectories × 50 timesteps
    - 2700 total trajs — ideal for 3D (large dataset)
...
BOUNDARY_CONDITIONS = {"x": "OPEN", "y": "OPEN", "z": "OPEN"}

N_FIELDS = 6  # density, pressure, temperature, velocity_{x,y,z}
N_CONSTANT_FIELDS = 0
IN_CHANNELS = N_STEPS_INPUT * N_FIELDS + N_CONSTANT_FIELDS  # 24
OUT_CHANNELS = N_FIELDS  # 6

# 2160 train trajectories × 46 windows = 99,360 samples
SAMPLES_PER_EPOCH = 99_360

# ─── Training constants (shared across models) ───────────────────────────────
TRAINING_ITERATIONS = 110_000
WARMUP_ITERATIONS_PERCENTAGE = 0.05

BATCH_SIZE = 2  # configs/data/turbulence_gravity_cooling.yaml
NUM_WORKERS = 12
GRAD_CLIP = 1.0
