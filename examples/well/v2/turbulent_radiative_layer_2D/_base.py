...
"""Shared config for turbulent_radiative_layer_2D experiments (v2).

Dataset: turbulent_radiative_layer_2D
    - 2D, 128×384, 4 dynamic fields, 0 constant fields
    - Dynamic fields: density, pressure, velocity_{x,y}
    - ~72 train trajectories × 101 timesteps
    - 6.9GB total — fast iteration, good for development
...
BOUNDARY_CONDITIONS = {"x": "PERIODIC", "y": "OPEN"}

N_FIELDS = 4  # density, pressure, velocity_{x,y}
N_CONSTANT_FIELDS = 0
...
BATCH_SIZE = 64  # configs/data/turbulent_radiative_layer_2D.yaml
NUM_WORKERS = 12
GRAD_CLIP = 1.0
