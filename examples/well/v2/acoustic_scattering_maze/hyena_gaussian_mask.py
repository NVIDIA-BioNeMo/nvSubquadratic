"""Hyena config with Gaussian modulation mask for acoustic_scattering_maze (v2).
...
from examples.well.v2.acoustic_scattering_maze._base import DATA_DIM
from examples.well.v2.acoustic_scattering_maze.hyena import NUM_HIDDEN_CHANNELS
...
def get_config() -> ExperimentConfig:
    """Build Hyena + Gaussian mask config for acoustic_scattering_maze."""
