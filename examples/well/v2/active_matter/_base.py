...
"""Shared config for active_matter experiments (v2).

Dataset: active_matter
    - 2D, 256×256, 11 dynamic fields, 0 constant fields
    - Dynamic fields: concentration, velocity_{x,y},
      D_{xx,xy,yx,yy}, E_{xx,xy,yx,yy} (deformation tensors)
    - ~175 train trajectories × 81 timesteps
    - Phase 3 scaling study dataset
...
N_FIELDS = 11  # concentration + velocity(2) + D(4) + E(4)
N_CONSTANT_FIELDS = 0
IN_CHANNELS = N_STEPS_INPUT * N_FIELDS + N_CONSTANT_FIELDS  # 44
OUT_CHANNELS = N_FIELDS  # 11

# ~175 train trajectories × 77 windows = 13,475 samples
SAMPLES_PER_EPOCH = 13_475
