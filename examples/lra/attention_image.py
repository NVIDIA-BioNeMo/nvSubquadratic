...
# Training parameters
BATCH_SIZE = 32 # Attention is more memory intensive
TRAINING_ITERATIONS = 100_000
LEARNING_RATE = 1e-4 # Attention often needs lower LR
WEIGHT_DECAY = 0.05
...
def get_config() -> ExperimentConfig:
    ...
    config.wandb = WandbConfig(job_group="lra_image", project="nvsubquadratic")
