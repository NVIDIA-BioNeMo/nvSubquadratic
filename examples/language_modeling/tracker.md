...
| 2.4 | LR = 1e-3    | `learning_rate=1e-3` | `small_{hyena,attention}_lr1e3.py` | ✅ Done | 24.57     | 29.53    | 136572       | 136573      | Hyena leads by 5 PPL          |
...
| Small (LR=1e-3)   | 128     | 24.57     | 29.53    | −4.96   | **Hyena** |
...
| 1e-3               | 24.57     | 29.53     | Best Hyena so far; Attention also improved |
...
| —          | 136573 | 2.4   | `small_attention_lr1e3.py` | all6000   | 2    | 128     | ✅ Done    | 29.53  | LR=1e-3              |
...
- **2026-02-19**: Attention LR=1e-3 (job 136573) finished at **29.53 PPL**. Hyena (24.57) still leads by ~5 PPL.
...
**Status**: Phase 1.4 (medium re-run BS=128) pending; Phase 2.4 Done.
