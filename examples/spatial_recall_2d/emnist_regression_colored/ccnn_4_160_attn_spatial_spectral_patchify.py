...
"""Config file for EMNIST spatial recall regression (2D) with Transformer (Attention) backbone and learnable spectral patchification.
...
INIT_STRIDE = 8.0  # Initial stride (learnable): 64 / 4 = 16x16 tokens
...
def get_config() -> ExperimentConfig:
    ...
    This configuration uses learnable spectral patchification:
    - SpectralPatchify (CKConvND + SpectralGaussianMaskND):
      ...
      - Initial stride of 4.0 reduces 64x64 canvas to ~16x16 tokens (256 vs 4096 with Linear)
