...
"""EMNIST Spatial Recall 2D - Mamba + Patchify M (Medium).
...
HIDDEN_DIM = 256  # Match mamba_m (Mamba is param-efficient)
HEADDIM = 32
EXPAND = 2
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST spatial recall with Mamba + Patchify M.
    ...
    config = spatial_recall_2d_base_experiment_config(
        ...
        wandb_job_group="spatial_recall_2d_emnist_simple_copy_m",
    )
