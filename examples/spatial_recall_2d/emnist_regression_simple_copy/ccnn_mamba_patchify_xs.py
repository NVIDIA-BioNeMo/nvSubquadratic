...
"""EMNIST Spatial Recall 2D - Mamba + Patchify XS (Extra-Small).
...
HIDDEN_DIM = 96  # Match mamba_xs (Mamba is param-efficient)
HEADDIM = 32
EXPAND = 2
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST spatial recall with Mamba + Patchify XS.
