...
"""EMNIST Spatial Recall 2D - Attention + Patchify S (Small).

Model Size: S (Small)
- Hidden dim: 256
- Params: ~1.84M + patchify overhead
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST spatial recall with Attention + Patchify S.
