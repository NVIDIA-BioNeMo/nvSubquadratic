...
"""EMNIST Spatial Recall 2D (Mask Selection) - Mamba + Patchify S.

Model Size: S (Small)
- Hidden dim: 160 (matches mamba_s)
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST mask selection with Mamba + Patchify S."""
