...
"""EMNIST Spatial Recall 2D (Mask Selection) - Hyena + Patchify S.
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST mask selection with Hyena + Patchify S."""
    config = spatial_recall_2d_base_experiment_config(
        in_channels=INPUT_CHANNELS,
        out_channels=OUTPUT_CHANNELS,
        hidden_dim=HIDDEN_DIM,
        training_iterations=TRAINING_ITERATIONS,
        wandb_job_group="spatial_recall_2d_emnist_mask_selection_s",
    )
