...
"""EMNIST Spatial Recall 2D (Color Selection) - Mamba + Patchify M.

Model Size: M (Medium)
- Hidden dim: 256 (matches mamba_m)
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST color selection with Mamba + Patchify M."""
