...
"""EMNIST Spatial Recall 2D (Color Selection) - Attention XS (Extra-Small).
...
Note: Running XS to verify if attention can learn color-based selection.
"""
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST color selection with Attention XS."""
