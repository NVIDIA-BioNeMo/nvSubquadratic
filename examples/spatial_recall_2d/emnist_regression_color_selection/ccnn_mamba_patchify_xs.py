...
"""EMNIST Spatial Recall 2D (Color Selection) - Mamba + Patchify XS.

Model Size: XS (Extra-Small)
- Hidden dim: 96 (matches mamba_xs for param parity)
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST color selection with Mamba + Patchify XS."""
