...
r"""Isotropic Hyena baseline — CIFAR-10 patch-merging ablation.

Architecture: flat 12-block ViT5ClassificationNet.
  - patch_size=16, hidden_dim=384, 12 blocks (~22 M params)
  - GAP readout, no CLS token, no APE, no RoPE
  - Scalar-ω₀ SIREN kernel: ω₀=10, L_cache=14 (224//16)
...
from examples.patch_merging.cifar10._base import IMAGE_SIZE, NUM_CLASSES, get_base_config
...
HIDDEN_DIM = 384
NUM_BLOCKS = 12
PATCH_SIZE = 16  # 224 // 16 = 14×14 grid
...
def get_config() -> ExperimentConfig:
    """Build isotropic Hyena config for CIFAR-10 single-GPU training."""
