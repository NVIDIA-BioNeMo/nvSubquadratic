...
"""EMNIST Spatial Recall 1D (Mask Selection) - Mamba S Causal.
...
HIDDEN_DIM = 224  # Causal S (~2.1M params)
HEADDIM = 32
EXPAND = 2
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST mask selection 1D with Mamba S (causal)."""
