...
"""EMNIST Spatial Recall 1D (Mask Selection) - Attention M Causal.
...
def get_config() -> ExperimentConfig:
    """Get the configuration for EMNIST mask selection 1D with Attention M (causal)."""
