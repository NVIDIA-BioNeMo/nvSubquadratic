#!/bin/bash
#SBATCH --job-name=imagenette-attn
...
#SBATCH --output=slurm/imagenette_attn_%j.out

# Imagenette ViT-B benchmark (160px)
# Usage:
#   sbatch examples/imagenet_classification/vit_b_benchmark_tiny_imagenet/run_imagenette_attention_patchify.sh

set -x

CONFIG_FILE="examples/imagenet_classification/vit_b_benchmark_tiny_imagenet/imagenette_attention_patchify.py"
