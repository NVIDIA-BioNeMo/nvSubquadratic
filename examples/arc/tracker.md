...
| ARCViT AdaLN         | 32.96M | 256 (128×2)       | 2x geodude | ⏳ Not started              | *n/a*                  | Config: `conditioning_ablation/cfg_vit_rearc_adaln.py` · DiT-style AdaLN-Zero on ViT · task token is NOT prepended; feeds per-layer shift/scale/gate · extra params vs concat (32.96M vs 17.20M) come from condition_proj per layer · ablation: does AdaLN help ViT as it does Hyena?             |
