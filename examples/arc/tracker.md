...
| Hyena (grid=single + circular)        | ~19M   | 256 (128×2)       | 2x geodude | 🔄 Running (SLURM 155589)   | **65.8%** (epoch 211)  | Config: `cfg_hyena_rearc_subq_ops_circular.py` · [WandB lxphnb5l](https://wandb.ai/implicit-long-convs/nvsubquadratic/runs/lxphnb5l) · `fft_padding="circular"`, `fft_backend="torch_fft"`, `compile=False` (subq_ops asserts against circular; 155567/155578 failed) · best ckpt `epoch=217-step=351416.ckpt` · currently epoch ~217, val=64.0%                                                                                       |
...
| Hyena (seq_concat / task-in-sequence) | ~19M   | 256 (128×2)       | 2x geodude | 🔄 Running (SLURM 155568)   | **64.7%** (epoch 294)  | Config: `cfg_hyena_rearc_seqtoken_subq_ops.py` · [WandB y4ow1gie](https://wandb.ai/implicit-long-convs/nvsubquadratic/runs/y4ow1gie) · `task_injection="seq_concat"`: task_tok prepended as row 0 of 16×16 patch grid (→ 17×16) before all 12 blocks; stripped before Unpatchify · best ckpt `epoch=294-step=475540.ckpt` · currently epoch ~309, val=61.7%                                                                            |
