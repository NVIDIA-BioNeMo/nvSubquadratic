"""Hyena ResNet + FiLM conditioning for ARC-AGI.

Same as cfg_hyena_rearc_film.py but using the custom subquadratic_ops_torch CUDA
FFT kernel (fft_backend='subq_ops'). Used for benchmarking the custom kernel
against the torch.fft baseline.
"""
