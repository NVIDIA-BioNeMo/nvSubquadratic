"""ViT-5-Large ImageNet-1k — FSDP HYBRID_SHARD benchmark.

Short benchmark run (~200 steps) to measure FSDP throughput on ViT-5-L (~304M params).
...
def get_config() -> ExperimentConfig:
    """Return the ViT-5-Large FSDP HYBRID_SHARD benchmark config."""
