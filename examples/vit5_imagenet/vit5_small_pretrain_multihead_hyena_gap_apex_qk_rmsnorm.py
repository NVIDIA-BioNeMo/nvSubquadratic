...
Same as vit5_small_pretrain_hyena_gap_apex_qk_rmsnorm.py except the global
convolution uses CKConvMultiheadND (dense within-head mixing) instead of the
depthwise CKConvND.

Key differences from vit5_small_pretrain_hyena_gap_apex_qk_rmsnorm.py:
