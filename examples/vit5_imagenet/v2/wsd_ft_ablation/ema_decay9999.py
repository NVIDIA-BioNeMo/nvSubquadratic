"""WSD finetuning ablation — EMA decay=0.9999 (half-life ~10K steps)."""
...
def get_config():
    """Return config with EMA decay=0.9999."""
    config = _base(lr=3e-5, wd=0.05)
    config.callbacks = [LazyConfig(LabeledEMAWeightAveraging)(decay=0.9999)]
    return config
