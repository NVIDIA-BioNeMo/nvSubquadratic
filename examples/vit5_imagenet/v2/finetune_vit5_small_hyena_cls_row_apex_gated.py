"""ViT-5-Small + Hyena CLS-row apex gated — ImageNet-1k fine-tuning.

Fine-tunes from pretrained run 0ryrnpxv (val/acc 80.91) using the ViT-5
...
PRETRAINED_RUN_PATH = "implicit-long-convs/nvsubquadratic/0ryrnpxv"


def get_config() -> ExperimentConfig:
    """Return the ViT-5-Small Hyena CLS-row apex gated fine-tuning config."""
    ...
    # ─── Network (Hyena CLS-row apex gated) ───────────────────────────────────
