"""ViT-5-Small + Hyena + GAP ImageNet-1k — Gated attention variant.

Based on v2/vit5_small_pretrain_hyena_gap_apex.py with a gated attention-style
dual nonlinearity following Hua et al. (2022):
