"""ViT-5-Small Hyena GAP apex — ImageNet-1k fine-tuning.

Fine-tunes from pretrained run c3mbeoc5 (val/acc 81.00) using the ViT-5
...
PRETRAINED_RUN_PATH = "implicit-long-convs/nvsubquadratic/hmqx5ujn"


def get_config() -> ExperimentConfig:
    """Return the ViT-5-Small Hyena GAP apex fine-tuning config."""
