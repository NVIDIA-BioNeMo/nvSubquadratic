"""ViT-5-Small + Hyena ImageNet-1k — register reduction head (Mamba-R).
...
def get_config() -> ExperimentConfig:
    """Return the ViT-5-Small + Hyena register-recycling config."""
    config = get_base_config()

    mixer_cfg = build_hyena_mixer(film_cfg=None, use_rope=False)
