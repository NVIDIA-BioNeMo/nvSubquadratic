"""Validation-only config for DALI optimised v2 — loads checkpoint from run 2y06y121.

Used to verify that the optimised DALI module produces identical validation
accuracy to the original before starting a fresh training run.
"""
