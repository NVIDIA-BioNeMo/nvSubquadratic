...
"""ViT-5-Small + Hyena + GAP ImageNet-1k — Optimized mixer variant.

Based on vit5_small_pretrain_hyena_gap_apex.py with three mixer-level changes
motivated by Mamba2 alignment and removing redundant operations:
...
2. QK norm removed: PixelHyena RMSNorm already controls the distribution
   entering the global conv, making a separate QK norm redundant.
