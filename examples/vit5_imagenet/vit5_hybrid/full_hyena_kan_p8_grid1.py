"""Full Hyena with KAN kernel – patch_size=8, grid_range=[-1, 1].

Identical to full_hyena_kan.py except:
  - patch_size = 8       (was 16 default in v5._base.PATCH_SIZE)
  - grid_range = [-1.0, 1.0]  (was [-5.0, 5.0] default in KANKernelND)
"""
...
def get_config() -> ExperimentConfig:
    """Return the full-Hyena KAN config with patch_size=8 and grid_range=[-1, 1]."""
