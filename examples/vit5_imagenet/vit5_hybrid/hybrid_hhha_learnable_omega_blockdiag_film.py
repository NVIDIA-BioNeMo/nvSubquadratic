"""Hybrid Hyena/Attention – 3:1 ratio (HHHA), block-diagonal learnable-ω₀ + FiLM.

Layout: H H H A H H H A H H H A
         └─────── 3 groups ─────┘

Combines three ideas on top of ``hybrid_hhha``:
...
def get_config() -> ExperimentConfig:
    """Build the HHHA hybrid config with block-diagonal learnable-ω₀ + FiLM kernels."""
