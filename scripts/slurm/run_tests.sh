...
#SBATCH --output=/home/dwromero/projects/nvSubquadratic-private/logs/vit5_tests_%j.out
#SBATCH --error=/home/dwromero/projects/nvSubquadratic-private/logs/vit5_tests_%j.err
...
PYTHONPATH=. python -m pytest tests/test_vit5_components.py -v -o "addopts=" 2>&1
