...
| [`fp16_fft_convolution/`](https://github.com/NVIDIA-BioNeMo/nvSubquadratic/blob/main/reports/fp16_fft_convolution/REPORT.md)                             | FP16 circular FFT convolution: dual-mean-centering derivation, accuracy + throughput vs the FP32 reference, and why the (stable, exact) FP16 path was kept opt-in rather than shipped as the default. |
