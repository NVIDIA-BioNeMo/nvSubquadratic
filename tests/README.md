...
│   ├── test_vit5_hierarchical.py         # Spatial hierarchy, lazy configs, checkpoint transfer
│   └── test_vit5_hierarchical_classification.py  # Token/register hierarchy and merger contracts
