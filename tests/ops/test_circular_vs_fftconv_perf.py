    ...
    for N in lengths:
        ...
        try:
            ...
            avg_circ, mem_circ = bench_op(
                lambda x=x, k_bhl=k_bhl: circular_fftconv1d_fp32_bhl(x, k_bhl),
                "circular_fftconv1d_fp32_bhl",
                repetitions,
                device,
                warmup,
...
def test_perf_mem_circular_vs_fftconv2d():
    ...
    for N in sizes:
        ...
        try:
            ...
            avg_circ, mem_circ = bench_op(
                lambda x=x, k_bhl=k_bhl: circular_fftconv2d_fp32_bhl(x, k_bhl),
                "circular_fftconv2d_fp32_bhl",
                repetitions,
                device,
                warmup,
...
def test_perf_mem_circular_vs_fftconv3d():
    ...
    for N in cubes:
        ...
        try:
            ...
            avg_circ, mem_circ = bench_op(
                lambda x=x, k_bhl=k_bhl: circular_fftconv3d_fp32_bhl(x, k_bhl),
                "circular_fftconv3d_fp32_bhl",
                repetitions,
                device,
                warmup,
...
if __name__ == "__main__":
    ...
    circular_fftconv1d_fp32_bhl: 0.000076s avg, peak_mem 11.0 MB
    ...
    circular_fftconv1d_fp32_bhl: 0.000070s avg, peak_mem 22.0 MB
    ...
    circular_fftconv1d_fp32_bhl: 0.000073s avg, peak_mem 44.1 MB
    ...
    circular_fftconv1d_fp32_bhl: 0.000088s avg, peak_mem 88.2 MB
    ...
    circular_fftconv1d_fp32_bhl: 0.000170s avg, peak_mem 176.3 MB
    ...
    circular_fftconv1d_fp32_bhl: 0.000356s avg, peak_mem 352.6 MB
    ...
    circular_fftconv1d_fp32_bhl: 0.000751s avg, peak_mem 705.2 MB
    ...
    circular_fftconv2d_fp32_bhl: 0.000083s avg, peak_mem 24.0 MB
    ...
    circular_fftconv2d_fp32_bhl: 0.000113s avg, peak_mem 93.7 MB
    ...
    circular_fftconv2d_fp32_bhl: 0.000440s avg, peak_mem 371.7 MB
    ...
    circular_fftconv2d_fp32_bhl: 0.001661s avg, peak_mem 1484.9 MB
    ...
    circular_fftconv2d_fp32_bhl: 0.006314s avg, peak_mem 5918.5 MB
    ...
    circular_fftconv2d_fp32_bhl: 0.027740s avg, peak_mem 23658.9 MB
    ...
    circular_fftconv3d_fp32_bhl: 0.000093s avg, peak_mem 26.3 MB
    ...
    circular_fftconv3d_fp32_bhl: 0.000093s avg, peak_mem 35.0 MB
    ...
    circular_fftconv3d_fp32_bhl: 0.000098s avg, peak_mem 49.2 MB
    ...
    circular_fftconv3d_fp32_bhl: 0.000155s avg, peak_mem 110.6 MB
    ...
    circular_fftconv3d_fp32_bhl: 0.000311s avg, peak_mem 229.7 MB
    ...
    circular_fftconv3d_fp32_bhl: 0.001268s avg, peak_mem 716.0 MB
    ...
    circular_fftconv3d_fp32_bhl: 0.002313s avg, peak_mem 1662.1 MB
