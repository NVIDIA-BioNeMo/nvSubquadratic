...
| HyenaND-S (HA)×6 + FiLM                     | Hybrid      | ✗           | TBD    | 82.0 ✅   |
| HyenaND-S (HHHA)×3                          | Hybrid      | ✗           | 22M    | 82.0 ✅   |
| HyenaND-S (HHHA)×3 + FiLM                   | Hybrid      | ✗           | TBD    | 81.7 ✅   |
...
| Model                     | p=16           | p=8                   | p=4           |
| ------------------------- | -------------- | --------------------- | ------------- |
| Attention                 | 81.8 ✅ (9.4)  | 84.3 ✅ / 84.4 (45.5) | 85.1 ✅ (317) |
| HyenaND-S (pure)          | 81.5 ✅ (10.0) | 83.7 ✅ / 83.4 (39.0) | 84.0 ✅ (155) |
| HyenaND-S (pure) + FiLM   | 📝             | 📝                    | 📝            |
| HyenaND-S (HA)×6          | 82.1 ✅ (9.7)  | 84.2 ✅ (42.3)        | 85.0 ✅ (236) |
| HyenaND-S (HA)×6 + FiLM   | 82.0 ✅        | 84.2 ✅               | 85.1 ✅       |
| HyenaND-S (HHHA)×3        | 82.0 ✅ (9.8)  | 84.0 ✅ / 83.7 (40.7) | 84.4 ✅ (196) |
| HyenaND-S (HHHA)×3 + FiLM | 81.7 ✅        | 83.8 ✅               | 84.7 ✅       |

> Where two numbers appear (`A / B`), `A` is the paper-published value and `B` is a recent rerun (800 ep, 500k steps) on the same config. Kept as a double until we decide which is canonical.
> '+ FiLM' rows = `+ LO+BD+FiLM` full-combo runs (800 ep, 500k steps). GFLOPs for + FiLM variants TBD but ≈ same as non-FiLM base rows.
