...
import torchmetrics
import wandb
from experiments.default_cfg import TextGenerationConfig
...
class TextPretrainingWrapper(LightningWrapperBase):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train/acc_top5", self.train_acc_top5, on_step=True, on_epoch=True, prog_bar=True, sync_dist=self.distributed)
    ...
    def on_validation_epoch_end(self):
        ...
        # Text Generation
        if self.cfg.text_generation.enabled and (self.current_epoch + 1) % self.cfg.text_generation.every_n_epochs == 0:
