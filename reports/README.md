...
| [`hyena2d_parallel_adapter/`](hyena2d_parallel_adapter/REPORT.md)                     | Zero-init parallel adapter on a frozen ViT for spatial-recall routing. Ablation ladder C0/C1/C2s/C2f at 196 and 784 tokens; FiLM on/off at matched settings; learned ‖W_up‖ is late-heavy. Capacity-vs-inductive-bias still open. | 2026-08 |
