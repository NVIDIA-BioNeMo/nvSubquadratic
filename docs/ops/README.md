...
| {ref}`circular_fftconv_fp16.py <ops-circular-fftconv-fp16>` | fp16      | circular      | depthwise      | Same as above for the circular case. Uses **dual mean-centering** for fp16 stability — see the [FP16 circular FFT convolution report](https://github.com/NVIDIA-BioNeMo/nvSubquadratic/blob/main/reports/fp16_fft_convolution/REPORT.md). |
