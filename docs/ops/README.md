...
| `fp32`             | Internal compute precision. The output dtype always matches `x.dtype` regardless.                                                              |
...
- **[`nvsubquadratic/modules/ckconv_nd.py`](../../nvsubquadratic/modules/ckconv_nd.py)** — the CKConv operator that composes these primitives.
