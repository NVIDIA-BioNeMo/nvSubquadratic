...
[`benchmarks/README.md`](https://github.com/NVIDIA-Digital-Bio/nvSubquadratic-private/blob/main/benchmarks/README.md)
...
See [`benchmarks/compare_flops.py`](https://github.com/NVIDIA-Digital-Bio/nvSubquadratic-private/blob/main/benchmarks/compare_flops.py)
...
- [FP16 FFT convolution results](https://github.com/NVIDIA-Digital-Bio/nvSubquadratic-private/blob/main/benchmarks/ops/FP16_FFTCONV_RESULTS.md)
