#!/bin/bash
# Driver for `bench_vit5_optimized.py` — submits to SLURM with the standard ViT-5-Small config.
#SBATCH --job-name=vit5-v2
#SBATCH --nodes=1
...
#SBATCH --output=/home/dwromero/projects/nvSubquadratic-private/logs/vit5_v2_%j.out
#SBATCH --error=/home/dwromero/projects/nvSubquadratic-private/logs/vit5_v2_%j.err
...
PYTHONPATH=. python benchmarks/vit5_imagenet/bench_vit5_optimized.py
