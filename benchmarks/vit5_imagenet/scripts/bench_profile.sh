...
#SBATCH --output=/home/dwromero/projects/nvSubquadratic-private/logs/vit5_prof2_%j.out
#SBATCH --error=/home/dwromero/projects/nvSubquadratic-private/logs/vit5_prof2_%j.err
...
PYTHONPATH=. python benchmarks/vit5_imagenet/bench_vit5_profile.py
